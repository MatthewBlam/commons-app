...
export function ConnectNotionButton({ onSourceAdded }: ConnectNotionButtonProps): React.JSX.Element {
  ...
  async function handleConnect(): Promise<void> {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : "Failed to connect to Notion";
  ...
  if (step === "pick") {
    return (
      <div className="space-y-1">
        ...
        <NotionPicker onSubmit={handlePickSubmit} onCancel={() => setStep("idle")} />
...
function NotionIcon(): React.JSX.Element {
  return (
    <svg fill="currentColor" fillRule="evenodd" height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path
        clipRule="evenodd"
